...
return [
    ...
    */
    ...
    'gt'                   => [
        'numeric' => 'Isian :attribute harus lebih besar dari :attribute :value.',
    ...
    */
    ...
    'custom' => [
        ...
        'name_of_recipient' => [
            'required' => 'Bidang isian nama penerima wajib diisi.',
        ],
        'full_address' => [
            'required' => 'Bidang isian alamat lengkap wajib diisi.',
        ],
        'quality_name' => [
            'unique' => 'Isian nama kualitas sudah ada sebelumnya.',
        ],
        'commodity_name' => [
            'required' => 'Bidang isian nama komoditas wajib diisi.',
            'unique' => 'Isian nama komoditas sudah ada sebelumnya.',
        ],
        'agriculture_name' => [
            'required' => 'Bidang isian nama hasil pertanian wajib diisi.',
            'unique' => 'Isian nama komoditas sudah ada sebelumnya.',
        ],
        'commodity_id' => [
            'required' => 'Bidang isian komoditas wajib diisi.',
            'unique' => 'Isian nama komoditas sudah ada sebelumnya.',
        ],
        'thumbnail' => [
            'required' => 'Bidang isian :attribute wajib diisi.',
        ...
        'phonenumber' => [
            'required' => 'Bidang isian nomor hp wajib diisi.',
            'numeric'              => 'Isian nomor hp harus berupa angka.',
        ],
        'gender' => [
            'required' => 'Bidang isian jenis kelamin wajib diisi.',
        ],
        'confirm_password' => [
            'required' => 'Bidang isian konfirmasi password wajib diisi.',
            'same'     => 'Isian konfirmasi password dan :other harus sama.',
        ],
        'store_name' => [
            'required' => 'Bidang isian nama toko wajib diisi.',
            'unique' => 'Isian nama toko sudah ada sebelumnya.',
        ],
        'city_id' => [
            'required' => 'Bidang isian kota wajib diisi.',
        ],

        'product_name' => [
            'required' => 'Bidang isian nama produk wajib diisi.',
        ],

        'agriculture_id' => [
            'required' => 'Bidang isian hasil pertanian wajib diisi.',
        ],

        'quality_id' => [
            'required' => 'Bidang isian kualitas produk wajib diisi.',
        ],

        'stock' => [
            'required' => 'Bidang isian stok produk wajib diisi.',
        ],

        'price' => [
            'required' => 'Bidang isian harga produk wajib diisi.',
            'between' => 'Isian harga produk harus antara :min dan :max.'
        ],

        'description' => [
            'required' => 'Bidang isian deskripsi produk wajib diisi.',
        ],
        ...
        'body' => [
            'required' => 'Bidang isian isi diskusi produk wajib diisi.',
        ],

        'body_review' => [
            'required' => 'Bidang isian isi ulasan produk wajib diisi.',
        ],
        
        'stars' => [
            'required' => 'Bidang isian jumlah bintang wajib diisi.',
        ],

        'checkout_id' => [
            'unique'     => 'Sudah melakukan pengisian Ulasan Produk',
        ],
    ],
