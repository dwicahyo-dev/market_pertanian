@extends('layouts.app')
@section('title', 'Daftar Produk Tidak Tersedia')
@section('content')
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="alert alert-primary alert-dismissible show fade mt-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    @foreach ($stocklessProducts as $product)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="{{ route('products.set-stocked', $product->id) }}"
                                                        onclick="event.preventDefault(); document.getElementById('set-stocked').submit();"
                                                        class="dropdown-item has-icon">
                                                        <i class="far fa-check-circle"></i> Set Tersedia
                                                    </a>
                                                    ...
                                                    <form id="set-stocked"
                                                        action="{{ route('products.set-stocked', $product->id) }}"
